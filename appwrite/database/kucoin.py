...
def createKuApi(client, database):
...
def createKuApiAtributes(client,database,collection):
  databases =Databases(client)
  ...
  databases.create_string_attribute(database['$id'], collection['$id'], 'apiPassphrase', 255, True)
