...
# ARG APPWRITE_KUCOIN_DATA='64cf6e2f197d1fce5222'
# ARG APPWRITE_KUCOIN_API='64cf6e2f5eb1ac0275c0'
# ARG FASTAPI='https://cryptoapi.hezik.nl/api/v2/'
# ARG FASTAPI_USER='ron'
# ARG FASTAPI_PASSWORD='Oldsch00l'
# ARG APP_ENV_API='cryptoapi.hezik.nl'
# ARG REDIS='redis://:eYVX7EwVmmxKPCDmwMtyKVge8oLd2t81@10.20.30.23:6379/5'
